...
class Module:
    ...
    def __init__(self) -> None:
        ...
        self.training = True # 默认 training 为 True
    ...
    def register_buffer(self, name: str, tensor: Optional[Tensor], persistent: bool = True) -> None:
        ...
        Args:
            ...
            persistent (bool): whether the buffer is part of this module's
                :attr:`state_dict`. 表示是否 保存 这个 buffers

        Example::

            >>> self.register_buffer('running_mean', torch.zeros(num_features))

        Buffers 表示 模型的一种状态变量，不同于 模型的 参数 parameters
    ...
    def apply(self: T, fn: Callable[['Module'], None]) -> T:
        ...
        传入 函数， 将所有子模块、tensor以及parameter进行函数调用
    ...
    def train(self: T, mode: bool = True) -> T:
        ...
        # 从模块本身到子模块 的 设置 self.training 属性
        self.training = mode
        for module in self.children():
            module.train(mode)
        return self
    ...
    # __repr__ 支持 print 操作 str(Modules)
    def __repr__(self):
